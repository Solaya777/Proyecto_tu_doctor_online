  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('JSON Response:', json); // Verifica la estructura completa del objeto JSON
        console.log('Body:', json.body); //

        if (json.body.accessToken) {
          auth.saveUser(json.body); // No necesitas cambiar nada aquí, dado que la función saveUser se corregirá
  ...
  return (
    <div>
      ...
      <link
        rel="stylesheet"
        type="text/css"
        href="assets/css/css/all.min.css"
      />
